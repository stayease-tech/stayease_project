        ...
        >
          <section className="relative px-24 w-[210mm] h-[297mm] border border-gray-400 text-sm">
            <div className="flex justify-end">
              <img
                alt="CompanyLogo"
                src={publicUrl + 'static/img/stayEase_icon.ico'}
              ...
              <table className="border-collapse border border-black w-full">
                <tbody className="text-center">
                  <tr className="border-b border-black">
                    <td className="border-r border-black py-1 px-2 w-[50%]">
            ...
            <h3 className="text-center mb-[2rem] text-xl">
              <b>ANNEXURE A</b>
            </h3>
          ...
          <section className="relative p-24 w-[210mm] h-[297mm] border border-gray-400 text-sm">
            ...
            <p className="pb-5">
              ESTANZIA EASE Private Limited ("STAYEASE")., a company
              incorporated under the provisions of the Companies Act, 1956
              bearing CIN U55200KA2024PTC185682, having its registered office at
              No, represented herein by its Community Manager AND the User (as
              named in Annexure A). The User and Stayease are together referred
            ...
            <p className="pb-5">
              B. The User intends to use the Premises on a subscription basis
              from Stayease for residential accommodation purposes and Stayease
              has agreed to provide the same.
            </p>

            <p className="pb-5">
              NOW, THIS AGREEMENT CONTAINS THE CONDITIONS OF USE GRANTED TO THE
              USER
            </p>
            ...
            <p className="pb-5">
              ...
              shall be paid by User on or before the Due Date for every month in
              advance. Charges for any incidental or additional service are not
              a part of User Fee. The User shall be liable to pay such
              incidental or additional charges as and when they become due to a
              relevant party. The User shall not withhold payment of the User
              Fee for any reason whatsoever, including any disputes. Withholding
              payments shall be deemed to be a breach of this Agreement. The
              User Fee does not include any taxes, cesses, duties, etc., and the
              same shall be charged by Stayease, as applicable by the laws in
              force, if any.
            </p>

            <p>
              <b>4. REFUNDABLE SECURITY DEPOSIT:</b> On the date of execution of
              this Agreement, the User has agreed to deposit; with Stayease, in
              trust, a security deposit of (Thousand Rupees Only "Deposit"), as
              security for the performance of the User's obligations under this
              Agreement. Stayease may at its discretion use the Deposit or any
              part thereof to cure any breach or default by the User under this
              Agreement, or to compensate Stayease for any damage that occurs/is
              caused as a result of the User's act or omission to perform any of
              the User's obligations hereunder. Stayease's right is not limited
              to the Deposit to recoup damage costs, and the User remains liable
              for payment of the balance dues under this Agreement. The User
              shall not apply or deduct any portion of the Deposit from any
              month's User Fee, including the last month of the Term. The User
              shall not use or apply the Deposit in lieu of payment of User Fee.
              The Deposit shall not carry any interest. The Deposit will be
              refunded to the User after 45 working days from the Subscription
              End Date after deducting unpaid charges/damages, if any. The
              refund will be done only through online transfer.
            </p>
          ...
          <section className="relative p-24 w-[210mm] h-[297mm] border border-gray-400 text-sm">
            <p className="pb-5">
              ...
              payable in Indian Rupee and shall be paid to the bank account of
              Stayease bearing bank account No. 8294210000010478, IFSC:
              DBSSOIN0294 with beneficiary name as 'ESTANZIA EASE (Stayease)
              PRIVATE LIMITED' (Online transfer only) for UPI Payments UPI ID -
              mystayease@dbs. Such payment shall be credited to the bank account
              of the Stayease on or before the fifth (5th) of every month in
              advance for the month. For Online Transfer - Credit Date on the
              bank a/c of the Stayease, will be taken as the date and the "Late
              Payment Fees" (Refer Annexure A) will be calculated
              proportionately. Please note Cash is not accepted as a manner of
              payment. For Cheque - The date of cheque deposit will be taken as
              the date of payment and late payment fees, if any will be
              calculated from the said date proportionately. The User will be
              informed of details via email. Without prejudice to Stayease's
              right to take legal action, the User agrees to pay a charge of
            ...
            <p className="pb-5">
              ...
              the change of mode of payment of all such payments under this
              agreement acceptable by the Stayease.
            </p>

            <p className="pb-5">
              <b>6. MOVE OUT AND DEDUCTIONS:</b> At the Subscription End Date, a
              Move-out Audit would be carried out by a representative of
              Stayease after scheduling and communicating it with the User or on
              before the Subscription End Date, on the basis of which the
              damages, other property maintenance expenses is ascertained.
            </p>
            ...
            <p className="pb-5">
              ...
              maintenance, waste management and any other maintenance related to
              the common areas of the building. Property maintenance will also
              be applicable on change of property as well as on the completion
              of the stay period of 11 months in the same premise.
            </p>

            <p className="pb-5">
              Property maintenance charge will only be applicable after the stay
              of more than one month in the same property. Further, to ensure
              the room and the property is well maintained Deep Cleaning,
              Fumigation and Painting would be carried out based on the move-out
              audit.
            </p>

            <p className="pb-5">
              An estimate of the Maintenance Expenses is given in Annexure A,
              which will attract a 10% escalation on a yearly basis for
              inflation. Please note, that in case the actual costs are above
              the amounts mentioned in Annexure A, the higher amount would be
              deducted.
            </p>
            ...
            <p className="pb-5">
              ...
              / amenities and requirements in respect of the Schedule Property
              as per the move-in audit conducted at the time of moving in.
            </p>

            <p>
              <b>7. LIMITED USE:</b> The User agrees and understands that he/she
              is granted a limited use of the Premises for residential purpose
              only, subject to timely payment of the User Fee and other charges.
              The rights granted hereunder are not intended to be in the nature
              of a licence or leave
            </p>
          ...
          <section className="relative p-24 w-[210mm] h-[297mm] border border-gray-400 text-sm">
            ...
            <p className="pb-5">
              <b>8. BACKGROUND VERIFICATION:</b> Stayease shall be entitled to
              carry out background verification on the User before or at any
              point of time Subscription Term through any agency and the cost
              for such background verification (Rs.500) shall be borne by the
              User.
            </p>

            <p className="pb-5">
              <b>9. USER CHARGES DEFAULT:</b> If any amounts due under this
              Agreement are not paid within the due date, the User agrees to pay
              a late fee to Stayease as mentioned in Annexure A
            </p>

            <p className="pb-5">
              <b>10. LOCK IN PERIOD:</b> In the event the Subscription Term as
              mentioned in Annexure A is not more than six (6) months, the
              entire Subscription Term shall be considered as lock-in period. In
              the event the Subscription Term is greater than six (6) months,
              the first six (6) months shall be considered as lock-in period.
            </p>

            <p className="pb-5">
              <b>11. TERMINATION GENERALLY:</b> If User defaults in fulfilling
            ...
            <p className="pb-5">
              <b>12. SPECIFIC TERMINATION:</b> In the event of default from the
              User on the payment of the User Charges, Utility charges, and
              other charges under this Agreement, for a period more than two (2)
              weeks, Stayease shall be entitled to terminate the Agreement by
              giving seven (7) days written notice to pay the outstanding dues.
              After expiry of the notice period of seven (7) days, if the User
              fails to rectify default in payment of outstanding dues, Stayease
              shall terminate this Agreement immediately, by deducting the
            ...
            <p className="pb-5">
              ...
              which shall be deducted from the Deposit at the time of moving
              out.
            </p>
            ...
            <p>
              ...
              User Fee for the remainder of the month and the User shall not be
              allowed to stay beyond the end of that month. In case, the User
              terminates this
            </p>
          ...
          <section className="relative p-24 w-[210mm] h-[297mm] border border-gray-400 text-sm">
            ...
            <p className="pb-5">
              ...
              termination/expiry of the agreement with the property owner, with
              a prior 30 days notice. In such an event, the User shall be
              entitled to pay the User fee for the notice period. The deductions
              shall remain same as mentioned in Clause 6. In the following
              events, Stayease shall terminate the Agreement immediately with
              deduction of two months User Fee:
            </p>
            ...
            <ul className="list-disc px-10 pb-5">
              ...
              <li>
                Misbehaviour with the other occupants of the Premises and
                Stayease
              </li>
            ...
            <p className="pb-5">
              The User shall not be entitled to request the Stayease to adjust
              the User fee from the security deposit at any point of time during
              the License Term.
            </p>

            <p className="pb-5">
              In the event the User stays in the Premises even after the expiry
              or termination of the Agreement, without prejudice to the rights
              of Stayease to take appropriate legal action against the User
              under this Agreement or under law, the User shall be liable to pay
              twice the amount of prorated User Fee per day to Stayease.
            </p>
            ...
            <p className="pb-5">
              <b>14. MAINTENANCE OF PREMISES:</b> User shall use the Premises,
              common area, furniture and all other amenities provided in the
              Premises carefully and not cause any damage to the same.
            </p>
            ...
            <p className="pb-5">
              ...
              among all residents. It is hereby agreed that 50% of the charges
              shall be borne by the service provider, while the remaining 50%
              shall be shared equally among all residents residing within the
              premises. This allocation of charges aims to ensure fairness and
              mutual responsibility among all parties involved, fostering
            ...
            <p className="pb-5">
              ...
              may be agreed between the Parties, may be executed after expiry of
              the Term.
            </p>
          ...
          <section className="relative p-24 w-[210mm] h-[297mm] border border-gray-400 text-sm">
            <p className="pb-5">
              ...
              or through a physical letter delivered by registered post to the
              registered addresses or to the Premises. For delivery through an
              email, email delivery receipt shall be considered as proof.
            </p>

            <p className="pb-5">
              <b>18. ENTIRE AGREEMENT:</b> The terms and provisions along with
              any annexures issued pursuant thereto form the entire and final
              Agreement between the Parties. No modification, amendment or
              waiver of any provisions of this Agreement will be effective
              unless made in writing with mutual consent of the Parties.
            </p>

            <p className="pb-5">
              <b>19. SEVERABILITY:</b> If any term of this Agreement is held to
              be illegal, invalid or unenforceable, in whole or in part, other
              than such terms, the remaining terms shall not be affected.
            </p>

            <p className="pb-5">
              20. <b>GOVERNING LAW, JURISDICTION & DISPUTE RESOLUTION:</b> This
              Agreement shall be governed by and enforced as per the Laws in
              India and for the purpose of enforcement; the place of
              jurisdiction will be the city in which the Premises are located.
            </p>

            <p className="pb-5">
              All disputes shall be submitted for arbitration by a sole
              arbitrator under the Arbitration and Conciliation Act, 1996. In
              the event of any dispute arising out of or in connection with the
              Agreement, the Parties shall, at first instance, attempt to
              amicably resolve the same through settlement discussions (recorded
              by way of email or telephonic conversations).
            </p>
            ...
            <p className="pb-5">
              ...
              7 (seven) days of the receipt of the notice to arbitrate.
            </p>
            ...
            <p className="pb-5">
              ...
              losing Party. Till the continuation of the proceedings and passing
              of the award, all the Parties will bear their own share of cost
              and can recover the same, once the award is passed, from the
              losing Party.
            </p>

            <p className="pb-5">
              <b>21. ASSIGNING OF RECEIVABLES:</b> Stayease shall be entitled to
              assign any receivables under this Agreement to any third party
              without any prior notice of intimation to the User.
            </p>

            <p className="pb-5">
              <b>22. STAMP DUTY:</b> Payment of stamp duty or any deficiency in
              stamp duty on this Agreement shall be the responsibility of the
              User.
            </p>

            <p>
              <b>23. CONSEQUENTIAL LOSS:</b> Stayease shall not in any event be
              liable for special, indirect, punitive or consequential loss or
            ...
            <div className="p-1 border-t border-r border-l border-black border-b-0">
              ...
              <ol className="px-10 list-decimal">
                <li>
                  ...
                  month - Rs 100/- per day
                </li>
                <li>
                  &nbsp;&nbsp;&nbsp; SLAB-II: Between 11th to 20th day of the
                  month - Rs 250/- per day
                </li>
                <li>
                  &nbsp;&nbsp;&nbsp; SLAB-III: From the 21st day of the month
                  onwards - Rs 500/- per day
                </li>
              </ol>
            </div>
            ...
            <div className="p-1 border-t-0 border-r border-l border-black border-b">
              ...
              <ol className="px-10 pb-[5px] list-decimal">
                <li className="pb-5 ps-[15px]">
                  ...
                  proportionate common area charges. Utility charges for the
                  room are calculated as per the bills generated by the state
                  utility board(s) for the building. The unit rates for the said
                  bills shall be at the discretion of the corresponding state
                  utility board(s).
                </li>
                <li className="ps-[15px]">
                  Internet Services will be provided except for temporary
                  downtimes incurred due to third parties & technical
                  difficulties. The scope of Internet services are:
                  <ul className="list-disc px-10 pb-5">
            ...
            <div className="p-1 border border-black">
              ...
              <ol className="px-10 pb-[5px] list-decimal">
                <li className="ps-[15px] pb-5">
                  Premises can be used only for dwelling purpose.
                </li>
                <li className="ps-[15px] pb-5">
                  No damage to the Building or any part of it (including the
                  Premises).
                </li>
                <li className="ps-[15px] pb-5">
                  No rubbish or waste should be stored or burnt/destroyed in any
                  part of the Building.
                </li>
                <li className="ps-[15px] pb-5">
                  Not to litter or cause any kind of annoyance to the
                  neighbourhood.
                </li>
                <li className="ps-[15px] pb-5">
                  Noise - Keep the noise level within the tolerance of others in
                  the Premises and reduce if requested to do so. No noise shall
                  be caused between 10PM and 6AM which would affect the sleeping
                  by any third parties in the Premises/building or nearby
                  building.
                </li>
                <li className="ps-[15px]">
                  Avoid the following
                  <ul className="list-disc ps-[3rem] pb-5">
                    ...
                    <li>
                      Harassment in any form to anybody present within the
                      Premises
                    </li>
                    <li>
                      Fight/quarrel with the other occupants of the
                      building/instigating the other occupants to fight
                    </li>
                    <li>
                    ...
                    <li>
                      Alterations to the Premises, any electrical or furnishings
                      of the Premises.
                    </li>
                  </ul>
                </li>
                ...
                <li className="ps-[15px]">
                  ...
                  the Premises or Building, the User shall be liable to pay the
                  cost of repairs/replacement due to such damage. If the User
                  fails to pay the cost, Stayease shall deduct such cost from
                  the Deposit and claim for the balance cost of the repairs from
                  the User. Stayease shall carry out the repairs of the below
                  items and shall be entitled for reimbursement of the
                  repairs/replacement cost from the User in the
                  Premises/Building, for the items including but not limited to
                  the following:
                  <ul className="list-disc ps-[3rem] pb-5">
                    <li>Any damages/failure to the electrical items;</li>
                    <li>Physical damages to the electronics items;</li>
                    <li>
                      Physical damages caused to any of the furniture or
                      furnishings;
                    </li>
                    <li>Damages to bath fittings;</li>
                    <li>Damages to any of the kitchen appliances;</li>
                    <li>
                      Repairs/Replacement of any part for any of the
            ...
            <div className="p-1 border border-black">
              ...
              <ol start="10" className="px-10 pb-[5px] list-decimal">
                <li className="ps-[15px]">
                  ...
                  <p className="pb-[1rem]">
                    The User shall keep the pets in the Premises under the
                    condition that the pets shall not be allowed in the common
                    areas of the Building or other premises of the Building and
                    no littering on the common areas of the Building, hallways,
                    corridors or any other premises in the Building.
                  </p>
                  <p className="pb-[1rem]">
                    In the event of breach of any of the condition of Pet
                    Policy, the User shall pay an amount of Rs.1,000/- as
                    penalty per breach and if the User continues to breach the
                    Pet Policy for more than three (3) times, Stayease shall be
                    entitled to terminate the Agreement by giving 7 (seven) days
                    prior written notice.
                  </p>
                  <p className="pb-[1rem]">
                    The User shall be responsible for all the acts of the pets
                    and the User shall indemnify Stayease for any loss or damage
                    that may occur due to the act of the Pets.
                  </p>
                  <p className="pb-[1rem]">
                  ...
                  <p className="pb-[1rem]">
                    ...
                    responsibility of the User provided the same shall not cause
                    any disturbance to any other occupants.
                  </p>
                </li>
              </ol>
            </div>
            ...
            <div className="p-1 border border-black">
              <ol start="11" className="px-10 pb-[5px] list-decimal">
                ...
                <li className="ps-[15px] pb-5">
                  ...
                  depletion of borewells or the unavailability of water sources,
                  resulting in the necessity of relying on water tankers for
                  water supply, the associated charges shall be distributed
                  equitably among all residents. It is hereby agreed that 50% of
                  the charges shall be borne by the service provider, while the
                  remaining 50% shall be shared equally among all residents
                  residing within the premises. This allocation of charges aims
                  to ensure fairness and mutual responsibility among all parties
                ...
                <li className="ps-[15px] pb-5">
                  ...
                  that in the event any action is taken by the local
                  authorities/police against the User or the co-occupants, the
                ...
                <li className="ps-[15px] pb-5">
                  ...
                  belongings in the dedicated space provided by the management.
                ...
                <li className="ps-[15px] pb-5">
                  ...
                  ensure transparency and security of personal belongings.
                </li>
              </ol>
            </div>
          ...
          <section className="relative p-24 w-[210mm] h-[297mm] border border-gray-400 text-sm">
            <div className="p-1 border border-black">
              <ol start="20" className="px-10 pb-[5px] list-decimal">
                <li className="ps-[15px] pb-5">
                  <b>Cleaning Timing:</b> Cleaning sessions will be scheduled
                  during the following times:
                  <br />
                  <br />
                  9:00 am to 6 PM MON - SAT
                  <br />
                  <br />
                  Users are expected to make necessary arrangements to
                  accommodate these timings. The management will not be
                ...
                <li className="ps-[15px] pb-5">
                  ...
                  <br />
                  <br />
                  Advance Notification: Users interested in upgrading to a
                  larger room must notify the management in advance. This
                  advance notice is necessary to arrange the room and ensure its
                  availability.
                  <br />
                  <br />
                  Calculation of Rent: The higher rent for the upgraded room
                  will be initiated and calculated from the day the user moves
                  into the upgraded room.
                  <br />
                  <br />
                  Upfront Payment: An upgraded deposit, along with the revised
                  prepaid rent, will be required to be paid upfront before
                  moving into the upgraded room.
                  <br />
                  <br />
                  Subject to Availability: Upgradation to a bigger room is
                  subject to availability. In the event that a larger room is
                ...
                <li className="ps-[15px] pb-5">
                  ...
                  <ul className="list-disc ps-[1rem]">
                    <li className="pb-5">
                      ...
                      serve their notice period at the beginning of the month.
                    ...
                    <li className="pb-5">
                      ...
                      before moving out. Failure to do so may result in
                      penalties or forfeiture of deposit.
                    </li>
                  </ul>
                </li>
              </ol>
          ...
          <section className="relative p-24 w-[210mm] h-[297mm] border border-gray-400 text-sm">
            <div className="p-1 border border-black">
              <ul className="list-disc px-[4rem]">
                <li className="pb-5">
                  <b>Compliance with Terms:</b> It is the responsibility of the
                  user to comply with the notice period terms outlined in the
                ...
                <li className="ps-[15px]">
                  ...
                  <div className="pb-[5px] pt-5">
                    <p className="pb-[1rem]">
                      ...
                      a month at no additional charge. If the guest stay exceeds
                      2 days in a month, an amount of Rs. 500 (Rupees Five
                      Hundred Only) per day per guest shall be charged as a
                    ...
                    <p className="pb-[1rem]">
                      ...
                      guest(s) shall be subject to permission from other
                    ...
                    <p className="pb-[1rem]">
                      ...
                      conditions mentioned above shall be applicable for a
                    ...
                    <p className="pb-[1rem]">
                      ...
                      shall be payable on actual consumption basis. It shall be
                    ...
                    <p className="pb-[1rem]">
                      ...
                      admitting a guest without receiving prior approval from
                      the management. If the User invites guest/s to the
                    ...
                    <p className="pb-[1rem]">
                      ...
                      during their stay in the premises.
                    </p>
                  </div>
                </li>
              </ol>
            ...
            <div className="px-10">
              <div className="pt-5">
                ...
                <p className="pb-5">
                  ...
                  the duration of my tenancy. I understand that failure to
                  comply with these terms may result in penalties or forfeiture
                  of deposit. By signing below, I confirm my acceptance of the
                ...
                <p className="pb-5">
                  ...
                  the terms to the resident to the best of our ability and
                  ensured that they understand their obligations as outlined in
                  the agreement. By signing below, we affirm our commitment to
                  uphold the terms of the rental agreement and provide the
                  necessary support to the resident throughout their tenancy
                  period.
                </p>
                <b>Signatures:</b>
              </div>
