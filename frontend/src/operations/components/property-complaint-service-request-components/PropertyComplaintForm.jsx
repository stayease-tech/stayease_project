...
function PropertyComplaintForm() {
    ...
    const propertyComplaintHandleChange = (e) => {
        ...
        setPropertyComplaintData(prev => {
            ...
            if (name === 'issueDesc' || name === 'preferredTime') {
                return {
                    ...prev,
                    [name]: value
                };
        ...
        <div className="lg:pb-2 pt-[5rem] lg:pt-[6rem]">
            ...
            <form className="max-lg:min-h-screen w-[100%] lg:w-[85%] mx-auto lg:my-8 pt-6 px-8 lg:p-10 lg:rounded-lg bg-white text-slate-800" onSubmit={propertyComplaintHandleSubmit} method='POST'>
                ...
                {currentComponent === '' && <>
                    ...
                    <input type="text" value={searchParams.get('roomNo') || ""} className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-xs sm:text-sm" readOnly />

                    <label htmlFor="bedLabel" className="text-[#D4A017] max-sm:text-sm"><strong>Room Number:</strong></label>
                    <input type="text" value={searchParams.get('bedLabel') || ""} className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-xs sm:text-sm" readOnly />

                    <label htmlFor="residentsName" className="text-[#D4A017] max-sm:text-sm"><strong>Resident Name:</strong></label>
                    <input type="text" value={searchParams.get('residentsName') || ""} className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-xs sm:text-sm" readOnly />

                    <label htmlFor="phoneNumber" className="text-[#D4A017] max-sm:text-sm"><strong>Phone Number:</strong></label>
                    <input type="text" value={searchParams.get('phoneNumber') || ""} className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-xs sm:text-sm" readOnly />
...
export default PropertyComplaintForm