...
function MoveOutChecklistForm({ isExpanded, setIsExpanded }) {
    ...
    const bedsData = location.state?.data;
    ...
    const [moveOutChecklistData, setMoveOutChecklistData] = useState({
        ...
        moveOutElectricalLighting: [],
        moveOutElectricalLightingComments: "",
        moveOutFurnitureFixtures: [],
        moveOutFurnitureFixturesComments: "",
        moveOutKitchenPlumbing: [],
        moveOutKitchenPlumbingComments: "",
        moveOutHousekeepingCleanliness: [],
        moveOutHousekeepingCleanlinessComments: "",
        moveOutRemarks: "",
    })
    ...
    const moveOutChecklistHandleChange = (e) => {
        const { name, value, type, checked } = e.target;

        setMoveOutChecklistData(prev => {
            if (type === 'checkbox') {
    ...
    const moveOutChecklistHandleSubmit = async (e) => {
        e.preventDefault();
        setIsSubmitting(true);

        try {
            const response = await axios.post('/operations/moveoutchecklist-form-submit/', moveOutChecklistData, {
                headers: {
        ...
        <div>
            ...
            <div className="flex-1 duration-300">
                ...
                <div className={`text-slate-800 max-lg:bg-white min-h-screen ${isExpanded ? 'ml-16 md:ml-64' : 'ml-16'} pt-[5rem] lg:pt-[6rem] px-6 pb-[1rem]`}>
                    <form className="w-[100%] lg:w-[98%] mx-auto lg:my-8 py-6 sm:p-8 lg:p-10 lg:rounded-lg md:bg-white text-slate-800" onSubmit={moveOutChecklistHandleSubmit} method='POST'>
                        <h1 className="text-center sm:text-xl lg:text-2xl font-semibold mb-4 sm:mb-8 lg:mt-0 text-[#D4A017]">MOVE-OUT CHECKLIST FORM</h1>

                        {currentComponent === 'MoveOutChecklistForm' && <>
                            <h3 className="font-semibold mb-4 text-stone-400 max-sm:text-sm">Fill up the details here...</h3>

                            <label htmlFor="checkOut" className="text-[#D4A017] max-sm:text-sm"><strong>Move-Out Date:</strong></label>
                            <input
                                type="text"
                                value={bedsData?.checkOut ? formatDateToDDMonYYYY(bedsData?.checkOut) : '-'}
                                className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-sm sm:text-sm"
                                readOnly />

                            <label htmlFor="propertyManager" className="text-[#D4A017] max-sm:text-sm"><strong>Audit Done By:</strong></label>
                            <input type="text" value={bedsData?.propertyManager || ""} className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-xs sm:text-sm" readOnly />
                        ...
                        {currentComponent === 'PropertyCondition' && <>
                            <div className="my-[20px]">
                                ...
                                {itemCategory.map((category, index) => (
                                    <label key={index} className="relative inline-flex items-center space-x-2 cursor-pointer pe-5 max-sm:text-sm mb-5">
                                        <input
                                            ...
                                            name="moveOutPropertyCondition"
                                            value={category}
                                            checked={moveOutChecklistData.moveOutPropertyCondition.includes(category)}
                                            onChange={moveOutChecklistHandleChange}
                                        />
                                        <span className="w-5 h-5 border-2 border-gray-500 rounded-md flex items-center justify-center peer-checked:bg-[#eba312] peer-checked:border-black">
                                            {moveOutChecklistData.moveOutPropertyCondition.includes(category) && "✔"}
                                        </span>
                                ...
                                <input
                                    type="text"
                                    value={moveOutChecklistData.moveOutPropertyConditionComments}
                                    onChange={moveOutChecklistHandleChange}
                                    name="moveOutPropertyConditionComments"
                            ...
                            <div className="flex gap-5 mt-5">
                                <button
                                    className="block w-full px-4 py-2 bg-[#D4A017] text-white text-base font-medium rounded cursor-pointer hover:bg-[#B8860B] max-sm:text-sm" onClick={() => dataHandleToggle('MoveOutChecklistForm')}
                        ...
                        {currentComponent === 'ElectricalLighting' && <>
                            <div className="my-[20px]">
                                ...
                                {itemCategory.map((category, index) => (
                                    <label key={index} className="relative inline-flex items-center space-x-2 cursor-pointer pe-5 max-sm:text-sm mb-5">
                                        <input
                                            type="checkbox"
                                            className="peer hidden"
                                            name="moveOutElectricalLighting"
                                            value={category}
                                            checked={moveOutChecklistData.moveOutElectricalLighting.includes(category)}
                                            onChange={moveOutChecklistHandleChange}
                                        />
                                        <span className="w-5 h-5 border-2 border-gray-500 rounded-md flex items-center justify-center peer-checked:bg-[#eba312] peer-checked:border-black">
                                            {moveOutChecklistData.moveOutElectricalLighting.includes(category) && "✔"}
                                        </span>
                                        <span className="peer-checked:text-[#D4A017]">{category}</span>
                                    </label>
                                ))}
                                ...
                                <input
                                    type="text"
                                    value={moveOutChecklistData.moveOutElectricalLightingComments}
                                    onChange={moveOutChecklistHandleChange}
                                    name="moveOutElectricalLightingComments"
                                    className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-xs sm:text-sm"
                                    placeholder="Enter any additional comments here"
                                />
                            </div>
                        ...
                        {currentComponent === 'FurnitureFixtures' && <>
                            <div className="my-[20px]">
                                ...
                                {itemCategory.map((category, index) => (
                                    <label key={index} className="relative inline-flex items-center space-x-2 cursor-pointer pe-5 max-sm:text-sm mb-5">
                                        <input
                                            type="checkbox"
                                            className="peer hidden"
                                            name="moveOutFurnitureFixtures"
                                            value={category}
                                            checked={moveOutChecklistData.moveOutFurnitureFixtures.includes(category)}
                                            onChange={moveOutChecklistHandleChange}
                                        />
                                        <span className="w-5 h-5 border-2 border-gray-500 rounded-md flex items-center justify-center peer-checked:bg-[#eba312] peer-checked:border-black">
                                            {moveOutChecklistData.moveOutFurnitureFixtures.includes(category) && "✔"}
                                        </span>
                                        <span className="peer-checked:text-[#D4A017]">{category}</span>
                                    </label>
                                ))}
                                ...
                                <input
                                    type="text"
                                    value={moveOutChecklistData.moveOutFurnitureFixturesComments}
                                    onChange={moveOutChecklistHandleChange}
                                    name="moveOutFurnitureFixturesComments"
                                    className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-xs sm:text-sm"
                                    placeholder="Enter any additional comments here"
                                />
                            </div>
                        ...
                        {currentComponent === 'KitchenPlumbing' && <>
                            <div className="my-[20px]">
                                ...
                                {itemCategory.map((category, index) => (
                                    <label key={index} className="relative inline-flex items-center space-x-2 cursor-pointer pe-5 max-sm:text-sm mb-5">
                                        <input
                                            type="checkbox"
                                            className="peer hidden"
                                            name="moveOutKitchenPlumbing"
                                            value={category}
                                            checked={moveOutChecklistData.moveOutKitchenPlumbing.includes(category)}
                                            onChange={moveOutChecklistHandleChange}
                                        />
                                        <span className="w-5 h-5 border-2 border-gray-500 rounded-md flex items-center justify-center peer-checked:bg-[#eba312] peer-checked:border-black">
                                            {moveOutChecklistData.moveOutKitchenPlumbing.includes(category) && "✔"}
                                        </span>
                                        <span className="peer-checked:text-[#D4A017]">{category}</span>
                                    </label>
                                ))}
                                ...
                                <input
                                    type="text"
                                    value={moveOutChecklistData.moveOutKitchenPlumbingComments}
                                    onChange={moveOutChecklistHandleChange}
                                    name="moveOutKitchenPlumbingComments"
                                    className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-xs sm:text-sm"
                                    placeholder="Enter any additional comments here"
                                />
                            </div>
                        ...
                        {currentComponent === 'HousekeepingCleanliness' && <>
                            <div className="my-[20px]">
                                ...
                                {itemCategory.map((category, index) => (
                                    <label key={index} className="relative inline-flex items-center space-x-2 cursor-pointer pe-5 max-sm:text-sm mb-5">
                                        <input
                                            type="checkbox"
                                            className="peer hidden"
                                            name="moveOutHousekeepingCleanliness"
                                            value={category}
                                            checked={moveOutChecklistData.moveOutHousekeepingCleanliness.includes(category)}
                                            onChange={moveOutChecklistHandleChange}
                                        />
                                        <span className="w-5 h-5 border-2 border-gray-500 rounded-md flex items-center justify-center peer-checked:bg-[#eba312] peer-checked:border-black">
                                            {moveOutChecklistData.moveOutHousekeepingCleanliness.includes(category) && "✔"}
                                        </span>
                                        <span className="peer-checked:text-[#D4A017]">{category}</span>
                                    </label>
                                ))}
                                ...
                                <input
                                    type="text"
                                    value={moveOutChecklistData.moveOutHousekeepingCleanlinessComments}
                                    onChange={moveOutChecklistHandleChange}
                                    name="moveOutHousekeepingCleanlinessComments"
                                    className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-xs sm:text-sm"
                                    placeholder="Enter any additional comments here"
                                />
                            </div>
                        ...
                        {currentComponent === 'Remarks' && <>
                            <div className="my-[20px]">
                                ...
                                <input
                                    type="text"
                                    value={moveOutChecklistData.moveOutRemarks}
                                    onChange={moveOutChecklistHandleChange}
                                    name="moveOutRemarks"
                                    className="mt-2 mb-3 text-black w-full p-2 mb-2 border border-gray-300 rounded text-xs sm:text-sm"
...
export default MoveOutChecklistForm