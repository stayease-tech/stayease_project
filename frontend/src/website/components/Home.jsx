    ...
    <div className="bg-[#1c1c1c] text-white overflow-x-hidden">
          ...
          >
            ...
            <div className="w-2/5 bg-[#eba312] flex items-center px-4 sm:px-6 lg:px-8">
              <p className="text-white text-sm sm:text-base lg:text-lg leading-relaxed">
                Experience a new way of living with a vibrant community and
                all-inclusive amenities designed for modern lifestyles.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex items-center">
              ...
              <span className="text-xl sm:text-2xl lg:text-3xl text-[#eba312] mx-12 lg:mx-12">
                ✱
              </span>
            </div>
          ))}
      ...
      <section className="bg-[#1c1c1c] border-b border-gray-600">
        <div className="grid lg:grid-cols-3 min-h-screen">
          ...
          <ScrollFadeIn
            direction="left"
            className="border-r border-gray-600 p-4 sm:p-6 lg:p-8"
          >
          ...
          <ScrollFadeIn
            direction="up"
            className="border-r border-gray-600 flex flex-col justify-center items-center px-6 sm:px-8 lg:px-12 xl:px-20 py-12 lg:py-20"
          >
            ...
            <p className="text-gray-300 text-base sm:text-lg lg:text-xl leading-relaxed mb-8 lg:mb-16 text-center max-w-2xl">
              At Stayease, We Redefine modern living with premium coliving
              spaces, luxury PG accommodations, and fully furnished homestays &
              shortstays in prime locations across Bangalore. Whether you're a
              working professional, student, or traveler, our spaces blend
              comfort, style, and Stayease community to create unforgettable
              living experiences.
            </p>
          ...
          <ScrollFadeIn
            direction="right"
            className="flex items-center justify-center py-12 lg:py-20 px-6 lg:px-8"
          >
                ...
                <svg className="w-full h-full" viewBox="0 0 288 288">
                  ...
                  <text className="text-xs fill-[#eba312] font-medium tracking-[0.2em] uppercase">
                    <textPath href="#circle-path" startOffset="0%">
                      WHERE QUALITY • MEETS COMFORT • WHERE QUALITY • MEETS
                      COMFORT •
                    </textPath>
                  </text>
                </svg>
      ...
      <section className="bg-[#1c1c1c] mt-12 lg:mt-20 border-y border-gray-600">
        <div className="grid grid-cols-1 lg:grid-cols-4">
          ...
          <ScrollFadeIn
            direction="left"
            className="border-r border-gray-600 flex items-center justify-center p-6 lg:p-8"
          >
        ...
        <ScrollFadeIn
          direction="up"
          className="border-y border-gray-600 flex justify-between items-center px-6 lg:px-8 py-4 lg:py-6"
        >
          <motion.button
      ...
      <section className="bg-[#1c1c1c] -mt-px">
        <ScrollFadeIn
          direction="up"
          className="text-center py-12 lg:py-16 px-6 lg:px-8"
        >
          ...
          <p className="text-gray-300 text-base sm:text-lg leading-relaxed max-w-5xl mx-auto">
            We understand that everyone has different needs when it comes to
            living space. That's why we offer a variety of accommodation options
            to suit your style and budget. No matter which option you choose,
            you'll benefit from all the advantages of the Stayease living
            experience.
          </p>
        </ScrollFadeIn>
        ...
        <ScrollFadeIn
          direction="up"
          className="flex justify-center items-center py-8 lg:py-12 space-x-8"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <ScrollFadeIn direction="left" delay={0} className="relative group">
              <div className="relative border border-gray-600 p-8 lg:p-10 bg-gradient-to-br from-[#eba312]/5 to-transparent hover:border-[#eba312] transition-all duration-300">
                ...
                >
                  <svg
                    className="w-8 lg:w-10 h-8 lg:h-10 text-[#eba312]"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <p className="text-gray-400 text-center text-sm mb-6">
                  Access your account, view rent history, KYC status, and manage
                  your profile
                </p>
            ...
            <ScrollFadeIn direction="up" delay={0.1} className="relative group">
              <div className="relative border border-gray-600 p-8 lg:p-10 hover:border-[#eba312] transition-all duration-300">
                ...
                >
                  <svg
                    className="w-8 lg:w-10 h-8 lg:h-10 text-gray-400 group-hover:text-[#eba312] transition-colors"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <p className="text-gray-400 text-center text-sm mb-6">
                  Have questions about a property? Send us your enquiry and
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => {
                    const enquirySection = document.querySelector(
      ...
      <section className="bg-[#1c1c1c] py-12 lg:py-20 -mt-px">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <ScrollFadeIn
            direction="up"
            className="relative border border-gray-600 p-8 sm:p-12 lg:p-16"
          >
            {/* Corner decorations */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-8 lg:gap-8">
              ...
              {[
                ...
                },
                {
                  title: 'PARKING',
                  subtitle: 'SPACE',
                  icon: 'M19 9l-7 7-7-7 M5 15v4a2 2 0 002 2h10a2 2 0 002-2v-4',
                },
                {
                  title: 'REGULAR',
                ...
                },
                {
                  title: 'WASHING',
                  subtitle: 'MACHINE',
                  icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z M12 9c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z',
                },
                {
                  title: 'WORKSPACE',
                  subtitle: 'SETUP',
                  icon: 'M2 4h20v16H2V4zm2 2v12h16V6H4zm2 2h.01M10 8h.01M14 8h.01',
                },
                {
                  title: 'COMMON',
                  subtitle: 'AREA',
                ...
                },
                {
                  title: 'COMMUNITY',
                  subtitle: 'INTERCOM',
                  icon: 'M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m-9 6a9 9 0 1018 0 9 9 0 00-18 0zm9-1a1 1 0 100-2 1 1 0 000 2z',
                },
              ].map((amenity, index) => (
                <ScrollFadeIn
                  key={index}
                ...
                >
                  ...
                  >
                    <svg
                      className="w-8 sm:w-9 lg:w-10 h-8 sm:h-9 lg:h-10 text-gray-400 group-hover:text-[#eba312] transition-colors"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <h3 className="text-[#eba312] text-xs sm:text-sm font-medium tracking-wider uppercase mb-1">
                    {amenity.title}
                  </h3>
                  <p className="text-[#eba312] text-xs sm:text-sm font-medium tracking-wider uppercase">
                    {amenity.subtitle}
                  </p>
                </ScrollFadeIn>
              ))}
            ...
            >
              ...
              >
                <p className="text-white text-base sm:text-lg leading-relaxed">
                  Peek into the world of Stayease through our gallery! We invite
                  you to envision yourself living in complete comfort,
                  connection, and convenience. Here, you'll discover the spaces
                  that make up our unique co-living experience.
                </p>
              </motion.div>
            </ScrollFadeIn>
              ...
              <div className="relative bg-white p-8 sm:p-10 lg:p-12 border-2 border-[#eba312] shadow-xl">
                ...
                <div className="space-y-6 lg:space-y-8">
                  ...
                  {[
                    ...
                    >
                      <label className="block text-gray-900 text-base lg:text-lg font-light">
                        {field.label}
                      </label>
                      <div className="relative">
                        {field.type === 'textarea' ? (
      ...
      <section className="w-full bg-gradient-to-r from-[#eba312] to-[#d4a017] py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl font-light text-white/90 mb-8 lg:mb-10">
            Access your portal, view rent history, KYC status, and manage your
            account
          </p>
          <Link to="/resident-login">
            <motion.button
