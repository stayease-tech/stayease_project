const PROPERTIES = [
    {
        ...
        desc: "We go beyond just offering stylish, fully furnished rooms and apartments. We provide a comprehensive package of offerings and amenities designed to simplify your living experience at Stayease. These are just a few of the offerings that set us apart. We're committed to providing you with everything you need to live at complete convenience.",
        ...
        priceBoardData: [
            ...
            { id: 2, type: 'Double Private', price: '22000' },
            { id: 3, type: '1 BHK', price: '30000' },
            { id: 4, type: '2 BHK', price: '42000' },
            { id: 5, type: '3 BHK', price: '62000' }
        ]
    },
    {
        id: 2,
        name: "Stayease Celestia",
        location: "Malleshwaram, Bangalore",
        desc: "Experience elevated living at Stayease Celestia, where every detail is designed for comfort and convenience. Our fully furnished spaces come with the best amenities to make your everyday life seamless and stress-free. Enjoy a modern bedroom that offers the perfect blend of style and relaxation, along with an equipped kitchen that lets you cook and feel right at home. With regular housekeeping services and easy access to laundry facilities, everything you need is taken care of—so you can simply move in and start living better at Stayease Celestia.",
        ...
        priceBoardData: [
            ...
            { id: 2, type: 'Double Sharing', price: '12999' },
            { id: 3, type: '1 BHK', price: '34999' },
            { id: 4, type: '3 BHK', price: '77999' },
        ]
    },
    {
        id: 3,
