        ...
        <div className='bg-white text-black px-[1rem] md:px-[8rem] pb-[3rem] pt-[8rem] min-h-screen'>
            ...
            <ul className='space-y-6 pb-10'>
                ...
                <NumberedSection title="1. Unregulated Rent Increases">
                    residents are left exposed financially since landlords can raise rent at any time without
                ...
                <NumberedSection title="2. Unclear Eviction Rules">
                    The terms under which a landlord may evict a resident are outlined in a rental
                ...
                <NumberedSection title="3. Property Damage Liability">
                    Without a formal agreement defining the resident's obligations, the landlord may find it
                ...
                <NumberedSection title="5. Loss of Tax Benefits">
                    Rental agreements are frequently used by residents to obtain tax exemptions for the
                ...
                <NumberedSection title="6. Lack of Clarity on Notice Periods and Moving Out">
                    residents may vacate at any moment without giving advance warning if there is no
                ...
                <NumberedSection title="Conclusion">
                    To protect the rights of both landlords and residents, a rental agreement is necessary.
