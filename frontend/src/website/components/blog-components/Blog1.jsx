        ...
        <div className='bg-white text-black px-[1rem] md:px-[8rem] pb-[3rem] pt-[8rem]'>
            ...
            <ul>
                <li className='pb-8'>
                    ...
                    <p>One of the primary benefits of coliving is its affordability. For millennials who are just starting out in their careers, high rents in metropolitan cities can be overwhelming. Coliving spaces in Bangalore offer a budget-friendly solution. By sharing common areas such as kitchens, living rooms, and utilities, residents save a significant amount on monthly expenses. This makes coliving the best choice for those looking to cut costs without compromising on comfort or location.</p>
                </li>
