    ...
    return (
        <DashPage>
            ...
            <div className="flex justify-center items-center">
                <div className="bg-white text-black p-4 max-w-[210mm]">
                    <p className="text-center text-gray-500">Preview not available. Click "Download PDF" to generate the document.</p>
                </div>
            </div>
        </DashPage>
    );
