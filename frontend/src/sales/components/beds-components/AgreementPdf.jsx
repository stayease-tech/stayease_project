    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            <Text style={[styles.tableCellLeft, { width: '50%' }]}>
              <Text style={styles.bold}>
                Type of Accommodation for use as residence
              </Text>
            </Text>
            <Text style={[styles.tableCell, { width: '50%' }]}>
          ...
          <View style={styles.tableRow}>
            <Text style={[styles.tableCellLeft, { width: '50%' }]}>
              <Text style={styles.bold}>Duration of Stay ("Term")</Text>
            </Text>
            <Text style={[styles.tableCell, { width: '50%' }]}>
              {resident.checkOut
          ...
          <View style={styles.tableRow}>
            <Text style={[styles.tableCellLeft, { width: '50%' }]}>
              <Text style={styles.bold}>
                Stayease Property ("Premise") name and address
              </Text>
            </Text>
      ...
      {/* PAGE 2 - User Subscription Agreement (Part 1) */}
      ...
      {/* PAGE 3 - User Subscription Agreement (Part 2) */}
      <Page size="A4" style={styles.page2}>
        <Text style={styles.title}>USER SUBSCRIPTION AGREEMENT</Text>
      ...
      {/* PAGE 4 - User Subscription Agreement (Part 3) */}
      <Page size="A4" style={styles.page2}>
        <Text style={styles.title}>USER SUBSCRIPTION AGREEMENT</Text>
      ...
      {/* PAGE 5 - User Subscription Agreement (Part 4) */}
      <Page size="A4" style={styles.page2}>
        <Text style={styles.title}>USER SUBSCRIPTION AGREEMENT</Text>
      ...
      {/* PAGE 6 - User Subscription Agreement (Part 5) */}
      <Page size="A4" style={styles.page2}>
        <Text style={styles.title}>USER SUBSCRIPTION AGREEMENT</Text>
      ...
      {/* PAGE 7 - Other Terms and Conditions */}
      <Page size="A4" style={styles.page2}>
        <Text style={styles.title}>USER SUBSCRIPTION AGREEMENT</Text>
        ...
        <View
          style={{ marginVertical: 4, borderWidth: 1, borderColor: '#000000' }}
        >
          <Text style={[styles.text, styles.bold, { padding: 4 }]}>
            Late Payment Fee
          </Text>
          ...
          <Text style={[styles.listItemDisc]}>
        ...
        >
          ...
          <View style={[styles.table, { marginHorizontal: 4 }]}>
            <View style={styles.tableRow}>
              <Text
      ...
      <Page size="A4" style={styles.page2}>
        ...
        >
          ...
          <Text style={[styles.listItemDisc]}>6. Avoid the following:</Text>
          ...
          <Text style={[styles.listItemDisc, { marginTop: 4 }]}>
      ...
      <Page size="A4" style={styles.page2}>
        ...
        >
          ...
          <Text
            style={[styles.text, { paddingHorizontal: 4, marginVertical: 4 }]}
          >
            9:00 am to 6 PM MON - SAT
          </Text>
          <Text
            style={[styles.text, { paddingHorizontal: 4, marginBottom: 4 }]}
          >
          ...
          <Text style={[styles.text, { paddingHorizontal: 4, marginTop: 4 }]}>
      ...
      <Page size="A4" style={styles.page2}>
        ...
        <Text style={[styles.text, styles.bold, { marginTop: 8 }]}>
          Declaration:
        </Text>
        ...
        <View style={styles.signatureSection}>
          <View>
            ...
            <Text style={[styles.signatureText, styles.bold]}>For User</Text>
          </View>
          <View>
            <View style={styles.signatureLine} />
