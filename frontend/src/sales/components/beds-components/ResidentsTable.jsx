...
function residentsTable({ isExpanded, setIsExpanded }) {
            ...
            <div className="flex-1 duration-300">
                ...
                <div className={`text-slate-800 bg-white lg:bg-gray-100 min-h-screen ${isExpanded ? 'ml-16 md:ml-64' : 'ml-16'} pt-[5rem] lg:pt-[6rem] px-6 pb-5`}>
                    <div className="w-[100%] lg:w-[98%] mx-auto lg:my-8 py-8 sm:p-8 lg:p-10 lg:rounded-lg lg:bg-white text-slate-800">
                        <h1 className="text-center sm:text-xl lg:text-2xl font-semibold lg:mt-0 mb-8 text-[#D4A017]">RESIDENTS DATA TABLE</h1>
                        ...
                        <div className="sm:flex justify-between">
                            <div className="sm:flex gap-2">
                                ...
                                <button
                                    className="block max-sm:w-full mb-3 px-4 py-2 bg-[#D4A017] text-white text-base font-medium rounded cursor-pointer hover:bg-[#B8860B] text-xs sm:text-sm" onClick={() => downloadCSV(outputData, 'Residents_Data.csv')}
                                ...
                                <tbody>
                                    {paginatedData.map((bedData, i) => (
                                        <tr className="" key={bedData.id}>
                                            ...
                                            <td className="border border-gray-300 px-4 py-2 text-center">{bedData?.resident_data?.phoneNumber}</td>
                                            <td className="border border-gray-300 px-4 py-2 text-center">{bedData?.resident_data?.email}</td>
                                            <td className="border border-gray-300 px-4 py-2 text-center">
                                                <div className="flex justify-evenly">
                                                    <FaEye className="block hover:text-[#D4A017] text-xl hover:cursor-pointer" onClick={() => viewresidentDataHandle(bedData)} />
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
