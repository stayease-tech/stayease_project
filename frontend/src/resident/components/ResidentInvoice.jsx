        ...
        <div className="bg-[#F5F5F0] min-h-screen">
            ...
            <div className={`pt-20 px-6 md:px-8 pb-8 transition-all duration-300 ${isExpanded ? "ml-64" : "ml-16"}`}>
                <div className="page-header">
                    ...
                    <button className="btn btn-outline" onClick={() => navigate("/resident/rent-history")}>Back to Rent History</button>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="card max-w-lg">
                        ...
                        <div className="card-body">
                            <Field label="Resident" value={invoice.residentName} />
