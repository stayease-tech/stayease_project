            ...
            <div className="page-header">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        onClick={() => navigate(`/supply/supply-user-activity-data`)}
                        type="button"
                    >
                        Prev
                    </button>
                                    ...
                                    {paginatedData.map((user, i) => (
                                        <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-3 py-1.5 text-xs text-gray-800">
                                                {`${calculateLoginDuration(user?.login_time, user?.logout_time)} ${(userLoginData[userLoginData.length - 1].login_time === user.login_time && user?.logout_time === null) ? '(updating in real-time)' : ''}`}
                                            </td>
                                        </tr>
                                    ))}
                                    <tr className="bg-gray-50 font-medium">
                                        <td colSpan="3" className="px-3 py-1.5 text-xs text-gray-800">Total Time Logged In</td>
