...
function OwnerTable() {
  ...
  const editOwnerHandle = (owner) => {
    navigate(`/supply/supply-owner-details/${owner?.id}`, {
              ...
              {loadingData ? (
                ...
                paginatedData.map((owner, i) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-1.5 text-xs text-gray-800">
                      {owner?.noOfProperties ?? 0}
                    </td>
                    <td className="px-3 py-1.5 text-xs text-gray-800 max-w-[180px] truncate">
                      {formatter.format(new Date(owner?.submittedDateAndTime))}
                    </td>
                    <td className="px-3 py-1.5 text-xs text-gray-800 max-w-[180px] truncate">
                      {formatter.format(new Date(owner?.updatedDateAndTime))}
                    </td>
                    <td className="px-3 py-1.5 text-xs text-gray-800">
                      <Eye
                        size={14}
