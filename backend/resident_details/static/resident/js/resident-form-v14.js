...
function validateForm(event) {
    ...
    fetch('/resident-details/resident-data/', { //Form submission API here
        method: 'POST',
        headers: {
        ...
        .then(data => {
            if (data.success) {
                ...
                event.target.reset();
                document.getElementById("dob").value = formattedDate;
                window.location.href = "https://stayease-contract.vercel.app/resident-details/resident-success/";
            } else {
