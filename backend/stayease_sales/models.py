...
class Tenant_Data(models.Model):
    ...
    studentEmployeeIdCopy = models.FileField(upload_to='documents/tenant-documents/%Y/%m/%d/', blank=True, null=True)
    ...
    tenantUser = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, blank=True, null=True, related_name='tenant_profile')
